...
export default function RequestNewCodeView() {
    ...
    return (
        <>
            ...
            <p className="text-2xl font-light text-white mt-5">Coloca tu e-mail para recibir {''}
            ...
            <form onSubmit={handleSubmit(handleRequestCode)} className="space-y-8 p-10 rounded-lg bg-white mt-10" noValidate>
                <div className="flex flex-col gap-5">
                    ...
                    <input id="email" type="email" placeholder="Email de Registro" className="w-full p-3 rounded-lg border-gray-300 border"
                        {...register("email", {
