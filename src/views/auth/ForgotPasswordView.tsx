...
export default function ForgotPasswordView() {
    ...
    return (
        <>
            ...
            <p className="text-2xl font-light text-white mt-5">Ingresa tu Correo {''}<span className=" text-fuchsia-500 font-bold"> y recibe las instrucciones</span></p>
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                <Link to='/auth/login' className="text-center text-gray-300 font-normal" >¿Ya tienes cuenta? Iniciar Sesión</Link>
                <Link to='/auth/register' className="text-center text-gray-300 font-normal">¿No tienes cuenta? Crea una</Link>
            </nav>
        </>
    )
}