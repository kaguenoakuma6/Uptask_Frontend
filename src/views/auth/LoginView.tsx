...
export default function LoginView() {
    ...
    return (
        <>
            ...
            <p className="text-2xl font-light text-white mt-5">Comienza a Planear tus proyectos {''}<span className=" text-fuchsia-500 font-bold"> Iniciando Sesión</span></p>
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                <Link to={'/auth/register'} className="text-center text-gray-300 font-normal">¿No tienes cuenta? Crea Una Aqui</Link>
