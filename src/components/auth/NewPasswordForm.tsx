import type { ConfirmToken, NewPasswordF } from "../../types";
...
export default function NewPasswordForm({ token }: NewPasswordFormProps) {
    ...
    const initialValues: NewPasswordF = {
        password: '',
    ...
    const handleNewPassword = (newPassword: NewPasswordF) => {
    ...
    return (
        <>
            <form onSubmit={handleSubmit(handleNewPassword)} className="space-y-8 p-10  bg-white mt-10" noValidate>
                ...
                <input
                    type="submit" value='Establecer Password'
