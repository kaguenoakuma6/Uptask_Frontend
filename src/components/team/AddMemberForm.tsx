...
export default function AddMemberForm() {
    ...
    const handleSearchUser = async (userEmail: TeamMemberForm) => {
        const data = {projectId, userEmail};
        ...
        <>
            <form className="mt-10 space-y-5" onSubmit={handleSubmit(handleSearchUser)} noValidate>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <input id="name" type="text" placeholder="E-mail del usuario a Agregar" className="w-full p-3  border-gray-300 border"
                        {...register("email", {
            ...
            <div className="mt-10">
                ...
                { mutation.data && <SearchResult member={mutation.data} reset={resetData}/> }
            </div>
        </>
    )
}